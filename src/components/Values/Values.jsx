...
const Values = () => {
  ...
  return (
    <section>
      <div className="max-w-[1400px] mx-auto px-10 py-20 gap-3 mt-15">
        <Heading highlight="Our" heading="Values" />

        <div className="flex md:flex-row flex-col mt-15md:gap-5 gap-15 ">
          {/* left values */}
          <div className="min-h-100 gap-15 flex flex-col justify-between">
            {leftValues}
          </div>
