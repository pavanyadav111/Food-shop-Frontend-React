...
const Products = () => {
  ...
  const categories = ['All', 'Fruits', 'Vegitables', 'Dairy', 'SeaFood']
    ...
    <section>
      <div className='max-w-[1400px] mx-auto px-10 py-20 '>
        ...
        <div className='mt-15 mx-auto w-fit '>
          <Link to='/allproducts' className="bg-gradient-to-b from-orange-400 to-orange-500 text-white px-8 py-3 rounded-lg md:text-lg text-md hover:scale-105 hover:to-orange-600 transition-all duration-300 cursor-poiinter ">View all</Link>
        </div>
      </div>
    </section>
  )
